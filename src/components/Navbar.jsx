...
function Navbar(){
    return (
        <NavBar>
            ...
            <NavCon>
                <Link to ="/" style={{textDecoration: 'none',color: 'black',opacity:'0.7'}}>Home</Link>
                <Link to ="/Shop" style={{textDecoration: 'none',color: 'black',opacity:'0.7'}}>Shop Collection</Link>
                <Link to ="/OurStory" style={{textDecoration: 'none',color: 'black',opacity:'0.7'}}>Our Story</Link>
                <Link to ="/Contact" style={{textDecoration: 'none',color: 'black',opacity:'0.7'}}>Contact</Link>
            </NavCon>
            </Container>
            <Container2>
                <Link to="/Login" style={{textDecoration: 'none',color: 'black',opacity:'0.7'}}>
                <div className="login" >
